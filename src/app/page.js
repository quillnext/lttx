...
//       const keywords = extractKeywords(allInputs);
//       router.push(`/ask-an-expert?keywords=${encodeURIComponent(keywords.length > 0 ? keywords.join(",") : "all")}&question=${encodeURIComponent(allInputs)}`);
//     } catch (error) {
...
//               return count + (searchableFields.includes(keyword) ? 1 : 0);
//             }, 0);
