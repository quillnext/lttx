...
//               </div>
//             </div>
//             <div className="fixed bottom-0 left-0 right-0 flex justify-between items-center bg-white shadow-t-lg z-50 lg:hidden p-4 ">
//               <button
//                 onClick={handleShare}
//                 className="flex-1 bg-secondary text-secondary-foreground py-3 rounded-full shadow-lg hover:bg-opacity-90 transition-all flex items-center justify-center gap-3 mx-2"
//                 title="Share Profile"
//               >
...
//               <button
//                 onClick={() => setIsModalOpen(true)}
//                 className="flex-1 bg-primary text-primary-foreground py-3 rounded-full shadow-lg hover:bg-opacity-90 transition-all flex items-center justify-center gap-2 mx-2"
//                 title="Ask a Question"
//               >
