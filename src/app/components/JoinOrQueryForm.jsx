...
//       .filter(word => word.length > 2 && !stopWords.includes(word)); // Exclude stop words
//   };
...
//       if (formData.purpose === "General Query" && formData.message) {
...
//             // Navigate to experts page with query params
//             router.push(`/expert?keywords=${encodeURIComponent(keywords.join(","))}`);
//           } else {
//             // Optionally show a message or redirect with no keywords
